...
//
//     final quizapp = quizappFromJson(jsonString);

import 'dart:convert';

Quizapp quizappFromJson(String str) => Quizapp.fromJson(json.decode(str));

String quizappToJson(Quizapp data) => json.encode(data.toJson());
